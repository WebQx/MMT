...
echo "MMT Landing Page: http://localhost"
echo ""
...
echo ""
echo "=== Next Steps ==="
echo "1. Visit the landing page at http://localhost"
echo "2. Access OpenEMR at http://localhost:8080 and complete setup"
echo "3. Create some test patients and encounters"
echo "4. Test the Django API at http://localhost:8001/api/"
echo "5. Use the Flutter app at http://localhost:3000 for transcription"
echo ""
